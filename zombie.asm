...
printint(int fd, int xx, int base, int sgn)
{
 ...
 339:	0f b6 92 1d 07 00 00 	movzbl 0x71d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4cf:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4d1:	b8 16 07 00 00       	mov    $0x716,%eax
...
00000590 <free>:
 ...
 5cf:	a3 ac 09 00 00       	mov    %eax,0x9ac
 5d4:	5b                   	pop    %ebx
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 5d7:	5d                   	pop    %ebp
 ...
 60a:	a3 ac 09 00 00       	mov    %eax,0x9ac
...
00000620 <malloc>:
 ...
 62c:	8b 15 ac 09 00 00    	mov    0x9ac,%edx
 ...
 6c7:	89 15 ac 09 00 00    	mov    %edx,0x9ac
 ...
 6e0:	c7 05 ac 09 00 00 b0 	movl   $0x9b0,0x9ac
 6e7:	09 00 00 
 6ea:	c7 05 b0 09 00 00 b0 	movl   $0x9b0,0x9b0
 6f1:	09 00 00 
 6f4:	b8 b0 09 00 00       	mov    $0x9b0,%eax
 6f9:	c7 05 b4 09 00 00 00 	movl   $0x0,0x9b4
 700:	00 00 00 
