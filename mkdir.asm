...
main(int argc, char *argv[])
{
  ...
  3f:	c7 44 24 04 65 07 00 	movl   $0x765,0x4(%esp)
  46:	00 
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 81 07 00 00       	mov    $0x781,%eax
...
000005e0 <free>:
 ...
 639:	a3 08 0a 00 00       	mov    %eax,0xa08
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 641:	5d                   	pop    %ebp
 ...
 65d:	a3 08 0a 00 00       	mov    %eax,0xa08
...
00000670 <malloc>:
 ...
 6eb:	8b 15 08 0a 00 00    	mov    0xa08,%edx
 ...
 726:	c7 05 08 0a 00 00 0c 	movl   $0xa0c,0xa08
 72d:	0a 00 00 
 730:	c7 05 0c 0a 00 00 0c 	movl   $0xa0c,0xa0c
 737:	0a 00 00 
 73a:	b8 0c 0a 00 00       	mov    $0xa0c,%eax
 73f:	c7 05 10 0a 00 00 00 	movl   $0x0,0xa10
 746:	00 00 00 
