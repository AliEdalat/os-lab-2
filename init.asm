...
main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 a0 0a 00 00       	push   $0xaa0
  ab:	68 d9 07 00 00       	push   $0x7d9
  b0:	e8 b5 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 dc 07 00 00       	push   $0x7dc
  bc:	6a 01                	push   $0x1
 ...
 48c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 61b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 620:	bb fb 07 00 00       	mov    $0x7fb,%ebx
...
free(void *ap)
{
 ...
 631:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 656:	73 18                	jae    670 <free+0x40>
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ad:	a3 a8 0a 00 00       	mov    %eax,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
