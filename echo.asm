...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 76 07 00 00 	movzbl 0x776(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 6f 07 00 00       	mov    $0x76f,%eax
...
000005e0 <free>:
 ...
 61f:	a3 00 0a 00 00       	mov    %eax,0xa00
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 65a:	a3 00 0a 00 00       	mov    %eax,0xa00
...
00000670 <malloc>:
 ...
 717:	89 15 00 0a 00 00    	mov    %edx,0xa00
 ...
 730:	c7 05 00 0a 00 00 04 	movl   $0xa04,0xa00
 737:	0a 00 00 
 73a:	c7 05 04 0a 00 00 04 	movl   $0xa04,0xa04
 741:	0a 00 00 
 744:	b8 04 0a 00 00       	mov    $0xa04,%eax
 749:	c7 05 08 0a 00 00 00 	movl   $0x0,0xa08
 750:	00 00 00 
