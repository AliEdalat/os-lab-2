...
printint(int fd, int xx, int base, int sgn)
{
 ...
 619:	0f b6 92 35 0a 00 00 	movzbl 0xa35(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 7af:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 7b1:	b8 2e 0a 00 00       	mov    $0xa2e,%eax
...
00000870 <free>:
 870:	55                   	push   %ebp
 871:	a1 a0 0d 00 00       	mov    0xda0,%eax
 ...
 8af:	a3 a0 0d 00 00       	mov    %eax,0xda0
 8b4:	5b                   	pop    %ebx
 8b5:	5e                   	pop    %esi
 8b6:	5f                   	pop    %edi
 8b7:	5d                   	pop    %ebp
 ...
 8ea:	a3 a0 0d 00 00       	mov    %eax,0xda0
...
00000900 <malloc>:
 ...
 90c:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 951:	39 05 a0 0d 00 00    	cmp    %eax,0xda0
 ...
 97b:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 9c7:	0d 00 00 
 9ca:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 9d1:	0d 00 00 
 9d4:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 9d9:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 9e0:	00 00 00 
