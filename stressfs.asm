...
putc(int fd, char c)
{
 ...
 5df:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5e1:	b8 49 08 00 00       	mov    $0x849,%eax
...
000006a0 <free>:
 6a0:	55                   	push   %ebp
 6a1:	a1 dc 0a 00 00       	mov    0xadc,%eax
 ...
 6df:	a3 dc 0a 00 00       	mov    %eax,0xadc
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
 ...
 71a:	a3 dc 0a 00 00       	mov    %eax,0xadc
...
00000730 <malloc>:
 ...
 73c:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 7d7:	89 15 dc 0a 00 00    	mov    %edx,0xadc
 ...
 7f0:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 7f7:	0a 00 00 
 7fa:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 801:	0a 00 00 
 804:	b8 e0 0a 00 00       	mov    $0xae0,%eax
 809:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 810:	00 00 00 
